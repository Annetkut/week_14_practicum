...
const myInformation = ["Anna", 22, 09, "Virgo"];
...
let countriesNewArray = countries.slice(); // Создаем копию массива
let firstCountry = countriesNewArray.shift(); // Извлекаем первый элемент из копии
console.log(firstCountry); // Выведет: Austria
console.log(countriesNewArray); // Выведет новый массив без первой страны: ['Belgium', 'Netherlands', 'Czechia', 'Croatia']
console.log(countries); // Выведет исходный массив без изменений: ['Austria', 'Belgium', 'Netherlands', 'Czechia', 'Croatia']
...
russianCities = ['Санкт-Петербург', 'Москва', 'Казань', ...russianCities];
...
function sumFirstPlusLast() {
    return numbers[0] + numbers[numbers.length - 1]
}
//сохраняем результат в переменную.
const result = sumFirstPlusLast();
console.log(result);
...
sortAndPrint = () => [...randomNumbers].sort((a, b) => a - b);
